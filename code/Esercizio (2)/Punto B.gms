...
$Ontext
Modello di Esercizio (2) - Punto B
$Offtext
...
*** VOLUMI ***
VolumiJ1(t)$(ord(t) gt 1)..              V('J1',t) =e= V('J1',t-1) + ApportiNaturali(t,'J1') - Q('d12',t) - Q('s13', t) + Q('p21', t) ;
VolumiJ2(t)$(ord(t) gt 1)..              V('J2',t) =e= V('J2',t-1) + ApportiNaturali(t,'J2') + Q('d12',t) - Q('d23',t) - Q('s23', t) - Q('p21', t) ;
