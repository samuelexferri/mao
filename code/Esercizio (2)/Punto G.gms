...
$Ontext
Modello di Esercizio (2) - Punto G
$Offtext
...
EInstallata1             Capacità eolica installata giornalmente (0-200 MW)
EInstallata2             Capacità eolica installata giornalmente (200-500 MW)
ProdEolica(t)            Produzione eolica effettiva
PDecurtata(t)            Potenza eolica decurtata
CostoEolica              Costo totale di produzione dell'eolica
;
...
ProduzioneEolica(t)      Produzione eolica effettiva
PotenzaDecurtata(t)      Potenza eolica decurtata

CostoProdEolica          Costi totale di produzione dell'eolica

Inquinamento             Inquinamento massimo
...
*** EOLICA ***
* VENTO: Low, Medium, High
ProduzioneEolica(t)$(ord(t) gt 1)..      ProdEolica(t) =e= (EInstallata1 + EInstallata2)*ProducibilitaEolica(t,'Medium') ;
PotenzaDecurtata(t)$(ord(t) gt 1)..      PDecurtata(t) =e= (EInstallata1 + EInstallata2) - ProdEolica(t) ;

CostoProdEolica..                        CostoEolica =e= EInstallata1*120 + EInstallata2*180 ;


*** INQUINAMENTO ***
Inquinamento..                           sum((Impianti,t), (P1(Impianti,t) + P2(Impianti,t))*Centrali(Impianti,'Coeff CO2')) - sum(Impianti, (P1(Impianti,'0') + P2(Impianti,'0'))*Centrali(Impianti,'Coeff CO2')) =l= 2500 ;


*** OBIETTIVI ***
EnergiaRichiesta(t)$(ord(t) gt 1)..      Carico(t,'Car') =l= sum(Impianti, (P1(Impianti,t) + P2(Impianti,t))) + sum(Flusso, Condotte(Flusso,'EnergyCoeff')* (Q1(Flusso,t) + Q2(Flusso,t))) + ProdEolica(t) ;

Obiettivo..      z =e= CostoPotenza + CostoFlussi + CostoEolica ;
...
display Bacini, Condotte, ApportiNaturali, Centrali, Carico, ProducibilitaEolica, V.l, P1.l, P2.l, PEspansa.l, Q1.l, Q2.l, QEspansa.l, EInstallata1.l, EInstallata2.l, ProdEolica.l, PDecurtata.l, z.l;
